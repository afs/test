...
//    // The RDF/XML path is slightly different so test it as well.
    ...
    @Test public void env() throws IOException {
        System.out.println(">env");
        System.out.println("isWindows = "+ Sys.isWindows);
        System.out.println("File.pathSeparatorChar = "+File.pathSeparatorChar);
        String s = System.getProperty("os.name");
        System.out.println("os.name = "+s);

        String baseStr1 = IRILib.filenameToIRI("./");
        String baseStr2 = IRILib.filenameToIRI(".");
